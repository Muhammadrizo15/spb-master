                    ...
                    <div className="nav_list-1 df align">
                        <div className="nav_device df mobile-nav_device">
                            <div className="nav_device-1 nav_device-1-active">
                                ...
                                <Link className="just__flexingfaa" to='/added-device'>
                                    <h2>Актуальное</h2>
                                    <span className="numbers__faCoigCXff">1</span>
                                </Link>
                            </div>
                            <div className="nav_device-2 mobile-nav_device-2">
                                <Link className="just__flexingfaa" to='/added-device-archive'>
                                    <h2>Архив</h2>
                                    <span className="numbers__faCoigCXff">1</span>
                                </Link>
                            </div>
                                ...
                                <div className="nav_applications-2 df mobile-nav_applications-2">
                                    <div className="applications_text-2 df align mobile-applications_text-2">
                                        ...
                                        <div className="double_buttons">
                                            {pause ? <a className="dubl-btn dubl-btn-free" href="#">Сбор предложения</a> : null}
